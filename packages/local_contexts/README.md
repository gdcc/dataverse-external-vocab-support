...
Use the [lc-cvoc-conf.json](./lc-cvoc-conf.json) file for production environments or [lc-sandbox-cvoc.json](./lc-sandbox-cvoc-conf.json) for testing environments. Edit the "cvoc-url" entry to reference your local Dataverse installation rather than "https://demo.dataverse.org" in the example files.
